package com.dtag.bmp.service.aggregation;
...
public class Application {
	...
	public Docket newsApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("Auxiliary").apiInfo(apiInfo()).select()
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Customer REST APIs").description("Customer REST APIs")
